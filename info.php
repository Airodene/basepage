...
<body>
	...
	<header>
		<div class="navBar" id="navBar">
			<div class="navBarWrapper blur">
				<ul class="navBarUl">
					<li class="itemLi">
						<a class="item button navBtn" href="index.php">
							Home
						</a>
					</li>
					<li class="itemLi">
						<a class="item button navBtn" href="info.php">
							<strong>Info</strong>
						</a>
					</li>
					<li class="itemLi">
						<a class="item button navBtn" href="addpagehere.php">Add</a>
					</li>
					<li class="itemLi">
						<a class="item button navBtn" href="addpagehere.php">Pages</a>
					</li>
				</ul>
			</div>
		</div>
	...
	<div class="content">
		...
		<p>Well actually, pretty much any web server with PHP support can run BasePage, as long as it supports installation in the root directory and CSS, Javascript and PHP 7</p>
	</div>
