...
<body>
		...
		<div class="navBar" id="navBar">
			<div class="navBarWrapper blur">
				<ul class="navBarUl">
					...
					<li class="itemLi">
						<a class="item button navBtn" href="info.php">Info</a>
					</li>
					<li class="itemLi">
	...
	<div class="content">
		...
		<p>An example of our button component</p>
	...
	<div class="content darkContent">
		...
		<!-- The body for the 2nd content section -->
		<p>Per-content-section dark mode allows flexible theming! Here's a light slider:</p>
